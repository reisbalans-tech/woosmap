...
module Woos
  module Map
    ...
    module Configuration
      # An array of valid keys in the options hash when configuring an {Woos::Map::API}
      ...
      DEFAULT_END_POINT = 'https://api.woosmap.com/'

      DEFAULT_DIRECTIONS_SERVICE = 'directions'
      DEFAULT_PLACES_SERVICE = 'address/autocomplete'
      DEFAULT_PLACE_DETAILS_SERVICE = 'address/geocode'
      ...
      def validate_config
        ...
        raise Woos::Map::InvalidConfigurationError, 'No valid authentication mode provided'
      end

      def validate_api_key
        raise Woos::Map::InvalidConfigurationError, 'No API key provided' unless api_key
      end

      def validate_digital_signature
        raise Woos::Map::InvalidConfigurationError, 'No client id provided' unless client_id
        raise Woos::Map::InvalidConfigurationError, 'No client secret provided' unless client_secret
      end
